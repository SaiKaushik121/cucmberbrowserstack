...
public class BStackDemoTest extends BrowserStackRemoteTest {
    ...
    public void addProductToCart() throws Exception {
        ...
        // Save the text of the product for later verifyvmaven-dependency-plugin:2.8:
        String productOnScreenText = driver.findElement(By.xpath("//*[@id=\"1\"]/p")).getText();
        // Click on add to cart button
        driver.findElement(By.xpath("//*[@id=\"1\"]/div[4]")).click();

        // See if the cart is opened or not
        AssertJUnit.assertTrue(driver.findElement(By.className("float-cart__content")).isDisplayed());
        ...
        AssertJUnit.assertEquals(productOnScreenText, productOnCartText);
    }
}
